                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex gap-4 items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm">Questions: 80 | Duration: 15 mins | Submitted on 5 June 2021</p>
                                    </div>
                                </div>
                                <button
                  ...
                  <BarChart data={comparisonData}>
                    ...
                    <div className="w-full lg:w-[400px] space-y-4">
                        <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                            ...
                            <div className="h-72">
                                <p className="text-gray-500">Syllabus content will be displayed here</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                            ...
                            <span><p className='text-gray-700 font-semibold'>You scored {score} question out of 15.</p>However it still need some improvements</span>
                ...
                <div className="fixed inset-0 bg-gray-200 bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-md">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            <div className='flex'>
                                <p className='w-8 h-5 rounded-full bg-purple-800 flex justify-center items-center text-white'>1</p>
                            ...
                            <div className='flex'>
                                <p className='w-8 h-5 rounded-full bg-purple-800 flex justify-center items-center text-white'>2</p>
                                <label htmlFor="percentile" className="block mb-2 text-sm font-medium text-gray-900">
                            ...
                            <div className='flex'>
                                <p className='w-8 h-5 rounded-full bg-purple-800 flex justify-center items-center text-white'>3</p>
